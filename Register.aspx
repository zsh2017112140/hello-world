...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="Resources/xnjdtsg.jpg" alt="第一张"/>
        </div>
        <div class="item">
            <img src="Resources/tsg.jpg" alt="第二张"/>
        </div>
        <%--<div class="item">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="name" runat="server"  CssClass="form-control" 
                placeholder="请输入姓名"></asp:TextBox>
        <div class="form-group">
            <label for="xueyuan">输入学院</label>
            <asp:TextBox ID="xueyuan" runat="server"  CssClass="form-control" 
                placeholder="请输入学院" ></asp:TextBox>
        <div class="form-group">
            <label for="class">输入班级</label>
            <asp:TextBox ID="banji" runat="server"  CssClass="form-control" 
                placeholder="请输入班级"></asp:TextBox>
            <label for="sex">选择性别</label><asp:RadioButtonList ID="RadioButtonList1" runat="server" 
            OnSelectedIndexChanged="RadionButton_Changed" AutoPostBack="True">
            <asp:ListItem Value="男" Text="男" /><asp:ListItem Value="女" Text="女" />
        ...
        <div class="form-group">
                        ...
                        <asp:TextBox ID="Check" type="check" runat="server" CssClass="form-control" 
                            placeholder="请再次输入密码" TextMode="Password"  ></asp:TextBox>
                    </div>
        <p style="text-align: right;color: red;position: absolute" id="info"></p>
        <asp:Button ID="confirm" runat="server" 
            CssClass="btn btn-default btn-lg btn-block" Text="确认" OnClick="Button_Confirm"  />
        <br />
    </div>
</div>
    </form>
